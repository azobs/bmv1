...
public interface ArticleApi {
    ...
    /**
     * DELETE /article/bm/v1/delete/{id} : Path used to delete an article in the system with its id
     *
     ...
     */
    @ApiOperation(value = "Path used to delete an article in the system with its id", nickname = "deleteArticleById", notes = "", response = Boolean.class, authorizations = {
    ...
    /**
     * GET /article/bm/v1/getby/{id} : Find an Article in the system by its id
     *
     ...
     *         or Unexpected error at the server side. (status code 500)
     */
    @ApiOperation(value = "Find an Article in the system by its id", nickname = "getArticleById", notes = "", response = ArticleDto.class, authorizations = {
    ...
    /**
     * POST /article/bm/v1/list : Path used to list article that respect certain criteria. A criteria is an instance of a Filter object
     *
     * @param filterRequest  (optional)
     * @return Article list found successfully (status code 200)
     */
    @ApiOperation(value = "Path used to list article that respect certain criteria. A criteria is an instance of a Filter object", nickname = "getArticleList", notes = "", response = ArticleDto.class, responseContainer = "List", authorizations = {
    ...
    /**
     * POST /article/bm/v1/page : Path used to list article page by page that respect certain criteria. With the Page object, we can configure the page number and size that we want
     *
     * @param filterRequest  (optional)
     * @return Article page found successfully (status code 200)
     */
    @ApiOperation(value = "Path used to list article page by page that respect certain criteria. With the Page object, we can configure the page number and size that we want", nickname = "getArticlePage", notes = "", response = PageofArticleDto.class, authorizations = {
    ...
    /**
     * POST /article/bm/v1/create : Path used to save a new Article of product in the system
     *
     ...
     *         or Unexpected error at the server side. (status code 500)
     */
    @ApiOperation(value = "Path used to save a new Article of product in the system", nickname = "saveArticle", notes = "", response = ArticleDto.class, authorizations = {
    ...
    /**
     * PUT /article/bm/v1/update : Path used to update or modify an existing article in the system
     *
     * @param articleDto  (optional)
     ...
     *         or Unexpected error at the server side. (status code 500)
     */
    @ApiOperation(value = "Path used to update or modify an existing article in the system", nickname = "updateArticle", notes = "", response = ArticleDto.class, authorizations = {
