...
public interface CategoryApi {
    ...
    /**
     * DELETE /category/bm/v1/delete/{id} : Path used to delete a category in the system with its id
     *
    ...
    @RequestMapping(
        ...
        value = "/category/bm/v1/delete/{id}",
    ...
    /**
     * GET /category/bm/v1/getby/{id} : Find a Category in the system by its id
     *
    ...
    /**
     * POST /category/bm/v1/list : Path used to list category that respect certain criteria. A criteria is an instance of a Filter object
     *
    ...
    /**
     * POST /category/bm/v1/page : Path used to list category page by page that respect certain criteria. With the Page object, we can configure the page number and size that we want
     *
     * @param filterRequest  (optional)
    ...
    /**
     * POST /category/bm/v1/create : Path used to save a new category of product in the system
     *
    ...
    /**
     * PUT /category/bm/v1/update : Path used to update or modify an existing category in the system
     *
     * @param categoryDto  (optional)
